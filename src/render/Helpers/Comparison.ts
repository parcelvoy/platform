 ...
 */
type Operator = '==' | '===' | '!=' | '!==' | '<' | '>' | '<=' | '>='
helpers.compare = function (a: any, operator: Operator, b: any, options: any) {
 ...
 * second value.
 */
helpers.eq = function (a: any, b: any, options: any): string {
 ...
 * second value.
 */
helpers.gt = function (a: any, b: any, options: any): string {
    if (arguments.length === 2) {
        options = b
        b = options.hash.compare
    }
 ...
 * second value.
 */
helpers.gte = function (a: any, b: any, options: any): string {
    if (arguments.length === 2) {
        options = b
        b = options.hash.compare
    }
...
helpers.lte = function (a: any, b: any, options: any): string {
    if (arguments.length === 2) {
        options = b
        b = options.hash.compare
    }
 ...
 * when falsy.
 */
helpers.neither = function (a: any, b: any, options: any): string {
    return util.value(!a && !b, this, options)
}
 ...
 */
helpers.not = function (val: any, options: any): string {
    return util.value(!val, this, options)
}
